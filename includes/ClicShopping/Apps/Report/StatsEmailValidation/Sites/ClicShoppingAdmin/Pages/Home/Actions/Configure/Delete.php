<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_StatsEmailValidation->getDef('alert_module_uninstall_success'), 'success', 'StatsEmailValidation');
    ...
    private static function removeMenu()
    {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_report_stats_email_validation');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_report_stats_email_validation']);
      }
    }
  }